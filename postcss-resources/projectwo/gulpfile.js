...
gulp.task('vendor:js', function () {
  return gulp
    .src(['./node_modules/bootstrap/dist/js/*', './node_modules/@popperjs/core/dist/umd/popper.*'])
...
gulp.task('vendor:build', function () {
  var jsStream = gulp
    .src(['./assets/js/vendor/bootstrap.bundle.min.js', './assets/js/vendor/popper.min.js'])
...
gulp.task(
  'build',
  gulp.series(gulp.parallel('scss', 'js:minify', 'vendor'), 'vendor:build', function copyAssets() {
